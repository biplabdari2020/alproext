...
--
-- Table structure for table `trndietrialdet`
--

DROP TABLE IF EXISTS `trndietrialdet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trndietrialdet` (
  `txtTrialNo` varchar(30) NOT NULL,
  `txtDieNo` varchar(20) NOT NULL,
  `dtTrialSent` datetime DEFAULT NULL,
  `dtTrialEnd` date DEFAULT NULL,
...
--
-- Dumping data for table `trndietrialdet`
--

LOCK TABLES `trndietrialdet` WRITE;
/*!40000 ALTER TABLE `trndietrialdet` DISABLE KEYS */;
/*!40000 ALTER TABLE `trndietrialdet` ENABLE KEYS */;
UNLOCK TABLES;
