...
--
-- Table structure for table `mst_machine_master`
--

DROP TABLE IF EXISTS `mst_machine_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mst_machine_master` (
...
--
-- Dumping data for table `mst_machine_master`
--

LOCK TABLES `mst_machine_master` WRITE;
/*!40000 ALTER TABLE `mst_machine_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `mst_machine_master` ENABLE KEYS */;
UNLOCK TABLES;
