...
$cnt = count($out_list['txtEmpNo']);

$attribute_list = array('txtEmpNo','txtEmpName','txtDesg','txtActiveFlag');
$pk = 'txtEmpNo';
$db_table_name = "mst_employee";
...
<body>
    ...
    <div class="myDiv">
        <div class="container">
            ...
            <td><a href="../php/MasterEmployeeEntry.php" class="myButton">Back</a></td>
                ...
                <?php
                    if($fail_insert_cnt > 0){
                        ...
                        <p>Below <b>Employee No</b> already present. Please add unique <b>Employee No</b></p>
                        <br>
