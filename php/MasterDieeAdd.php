...
$attribute_list = array('txtSectionNo','txtDieNo','txtPress','NumCavity','txtAlloy','numDieWt','numEstLife','numEstTrial','numEstInputRate','numEstOutputRate','numNitdrFreq','numLastRunWt','txtMfgBy','txtDieStatus');
$db_table_name = "mst_die";
$pk = 'txtDieNo';
//$db_insert_obj = DieMasterDataInsertDB($out_list,$attribute_list,$db_table_name);
...
<body>
    ...
    <div class="myDiv">
        <div class="container">
            ...
            <td><a href="../php/MasterDieeEntry.php" class="myButton">Back</a></td>
